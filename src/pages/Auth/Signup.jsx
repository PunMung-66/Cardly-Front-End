            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="h-screen flex items-center justify-center bg-[#B3EBF2] relative z-0">
                        <div className="bg-white rounded-xl shadow-lg flex flex-row overflow-hidden max-w-2xl w-full mb-20 mx-4">
                            <div className="w-full md:w-1/2 p-8">
                                <h2 className="text-2xl text-regal-blue font-medium text-center px-2 py-2">
                                    Sign up to{' '}
                                ...
                                >
                                    ...
                                    <button
                                        disabled={enable}
                                        className=" bg-regal-blue text-white p-4 rounded-md hover:bg-regal-blue-darkest transition duration-200 "
                                    >
                                        Signup
                                    </button>
